...
<div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center modal-overlay"
    ...
    <div class="bg-surface rounded-xl p-6 w-[28rem] max-h-[90vh] overflow-y-auto shadow-xl modal-card" onmousedown={() => mouseDownOnOverlay = false} onclick={(e) => e.stopPropagation()}>
